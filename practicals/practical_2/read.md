...
Below is the updated Markdown file with the What I Have Learnt, What Challenges I Have Faced, and How Did I Overcome sections replaced with your provided text, formatted as bullet points to match the style of the original document. I’ve kept the What I Have Done section unchanged, including the first four images in a row (using flexbox) and all images at width="30%" as per your previous requests. The structure remains consistent with the rest of the file.
markdown
# SWE p2
